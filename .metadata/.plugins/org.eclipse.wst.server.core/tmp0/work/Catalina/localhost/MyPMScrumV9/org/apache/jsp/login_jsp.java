...
if(!pmSession.isSession()){
	...
	out.println("Welcome back " + session.getAttribute("userName"));
      ...
      out.write("\r\n");
      out.write("<p>You will be redirect within 2 seconds, if not happened\r\n");
      out.write("<a href='dashboardAdmin.jsp'>click here</a>\t\t\t\t\t\t\r\n");
      out.write("<META HTTP-EQUIV=\"refresh\" CONTENT=\"1;URL=dashboardAdmin.jsp\">\r\n");
 } 
      out.write("\r\n");
      out.write("</table>\r\n");
      out.write("\r\n");
