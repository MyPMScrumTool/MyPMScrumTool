	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((userEmail == null) || userEmail.isEmpty() || (roleDesc == null) ||roleDesc.isEmpty() || (classNo == null) || classNo.isEmpty()){
			...
			if(roleObj == null)
			{
				...
				String msg = "Welcome to MyPmScrumTool for " + classNo + "click on the follwoing link to finish setting up your account the website"
						+ "<a href='createUserAccount.html?userEmail=1'>create user account </a>";
